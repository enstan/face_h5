...
//map--start
        ...
        console.log("canvas-Width",pageWidth);     //1080
        console.log("canvas-Height",pageHeight);    //1175    
        ...
        console.log("scaleAdaption",this.scaleAdaption); //0.3 
      ...
      this.positionAdaption = {
        ...
        console.log("documetn-Width",currentWidth);   //320
        console.log("documetn-Height",currentHeight);  //568
//
        this.position = {
            x: 0,
            y: 0
